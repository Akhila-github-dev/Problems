...
class Tester {
	...
	public static void main(String[] args) {
		...
		// Default format of LocalDate is yyyy-MM-dd

//		How can you find out the difference between 2 dates?
//		anss		date1.until(date2,TemporalUnit); 
//				until method finds the difference between the two dates and returns an integer value.
		...
		/*
		 * To display any date in default format we use of() method. of() takes
		 * parameters as public static LocalDate of(int year,Month month,int
		 * dayOfMonth)(where Month is enum ) Or public static LocalDate of(int year,int
		 * month,int dayOfMonth) This returns a LocalDate with the specified year, month
		 * and day-of-month
		 */
		System.out.println();
		...
		/*
		 * To access the date information we have certain methods like
		 * getYear(),getMonth(),getDayOfMonth() etc.
		 * 
		 */
		System.out.println();
		...
		/*
		 * The DateTimeFormatter class in Java is used for parsing dates in different
		 * formats. ofPattern method will create a formatter based on the pattern given
		 * by the programmer. For example, d MMM yyyy will format 2011-12-03 as '3 Dec
		 * 2011'.
		 */
		...
		/*
		 * getDayOfWeek() & getMonth() :- returns an enum instead of int value. To get
		 * int value, we can use getValue() methods
		 * 
		 * Try :-
		 * System.out.println("Month in Today's Date :- "+LocalDate.now().getMonth().
		 * getValue());
		 ...
		 * plusDays(),plusWeeks(),plusMonths(),plusYears(),minusDays(),minusWeeks(),
		 * minusMonths,()minusYears() All of these methods take parameters having Long
		 * datatype
		 */
		System.out.println();
		...
		System.out.println();
		/*
		 * Try :- Find the date 20 days ago and 4 months ago and 40 years ago
		 */
		...
		/*
		 * To Compare two dates we also have compareTo() method Method Signature of
		 * compareTo() :- int compareTo(chronoLocalDate date)
		 * 
		 * It returns the value 0 if the argument Date is equal to this Date. It returns
		 * a value less than 0 if this Date is before the Date argument. It returns a
