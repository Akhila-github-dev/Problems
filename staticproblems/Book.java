...
class Book {
	String bookId;
	String bookName;
	// This is a Static variable which stores the total noOfBooks that InfyLibrary
	// has.
	private static Integer noOfBooks = 1000;

	// Whenever a new Book object is created, a bookId is generated and the
	// noOfBooks increases by 1.
	...
	// This static method is used to return the total noOfBooks that the library
	// has.
