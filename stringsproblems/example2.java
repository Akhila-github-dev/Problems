...
public class example2 {
	public static void main(String[] args) {
		...
		System.out.println(name+department); //AkhiIT
		//==========================================
		
		String word1="bhanu" , word2="nu";
		
		System.out.println(word1=="bhanu");//true
		System.out.println(word1== ("bha"+"nu")); //true
		System.out.println(word1== ("bha"+word2)); //false
